...
#### Please read the entire readme! It covers important topics!
...
### Either grab the latest [release](https://github.com/boofiboi/releases) or follow the instructions below
#### Requirements:
...
## Mod compatibility
Mod compatibility is listed [here](PLACEHOLDER)

Guides on how to adapt mods are found in the [wiki](PLACEHOLDER)
...
If you like my work and would like to support me and my work maintaining/developing the fork, I have a [Ko-fi](https://ko-fi.com/boofi)
This is strictly voluntary, I will never gatekeep/paywall anything related to this. If you decide to support this means:
- You will recieve the same support when encountering an issue as anyone else.
- You will not recieve pre-release releases/early access.
- You will not recieve anything extra.

### I repeat: supporting me on Ko-fi gives you **NO** extra benefits! It is purely to provide me with a token of appreciation for my work.