...
As the original author seems to have abandoned the project/moved on with their life, I decided to create this fork and start adding improvements/fixing bugs from the original.
